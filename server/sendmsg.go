...
func SendMsgAPI(ServerVars *Variables, d DataAPI, w *http.ResponseWriter, t time.Time) {
	...
	ServerVars.LogActivity.Printf(ServerVars.LogActivityFormat, "Send Message(Channel)", "", d.Channel, "API", ts)
	ServerVars.LogMessage.Printf(ServerVars.LogMessageFormat, "Channel", d.Channel, "API", d.Msg, ts)
...
func (c *Client) SendMsgC(ServerVars *Variables, ch string, d *Data) {
	...
	ServerVars.LogActivity.Printf(ServerVars.LogActivityFormat, "Send Message(Channel)", "", ch, c.Username, t) // Logging activity
	ServerVars.LogMessage.Printf(ServerVars.LogMessageFormat, "Channel", ch, d.Username, d.Msg, t)              // Logging msg to log file
...
func (c *Client) SendMsgU(ServerVars *Variables, u string, d *Data) {
	...
	t := d.Time.Format("2006-01-02 15:04:05")
	ServerVars.LogActivity.Printf(ServerVars.LogActivityFormat, "Send Message(User)", "", u, c.Username, t) // Logging activity
	ServerVars.LogMessage.Printf(ServerVars.LogMessageFormat, "User", u, d.Username, d.Msg, t)              // Logging msg to log file
