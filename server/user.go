...
func (c *Client) DeleteUser(ServerVars *Variables, t time.Time) {
	...
	ServerVars.ActivityLogsChannel <- fmt.Sprintf(ServerVars.LogActivityFormat, "Delete User", "", c.Username, c.Username, t.Format("2006-01-02 15:04:05")) // Logging activity
}
